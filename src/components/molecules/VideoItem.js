...
const VideoItem = (props) => {
    ...
    return (
        <div onClick={() => props.handleVideoSelect(props.video)} className=' video-item item'>
            <img className='ui image' src={props.video.snippet.thumbnails.medium.url} alt={props.video.snippet.description} style={{ "minWidth": props.width, "maxWidth": props.width, "marginRight": marginright}} />
